...
if __name__ == '__main__':
    ...
    Lorenz_SRC_k3(direct_transfer=True)  # For classical framework, may occur divergence problem
    Lorenz_SRC_k3(direct_transfer=False)  # For the TS training framework
